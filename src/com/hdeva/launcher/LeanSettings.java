...
public class LeanSettings {
    ...
    public static final String SYSTEM_COLORS = "pref_system_colors";
    ...
    private static final boolean SYSTEM_COLORS_DEFAULT = true;
    ...
    public static boolean shouldUseSystemColors(Context context) {
        return prefs(context).getBoolean(SYSTEM_COLORS, SYSTEM_COLORS_DEFAULT);
    }
